...
//        String baseDir = getBaseContext().getFilesDir().getAbsolutePath();
        ...
        switch (entityType){
            ...
            case SpecificData.ENTITY_TYPE_2:
                fragmentBundle.putString(StaticData.EXTRA_INTENT_KEY_SELECTION,
                        editIntent.getStringExtra(StaticData.EXTRA_INTENT_KEY_SELECTION));
                if (action.equals(StaticData.ACTION_NEW)){
            ...
            case SpecificData.ENTITY_TYPE_3:
                // Terugkeren nr main ipv wat in manifest staat
                Intent returnIntent = new Intent(EditEntity.this, MainActivity.class);
                returnIntent.putExtra(SpecificData.ENTITY_TYPE, SpecificData.ENTITY_TYPE_3);
                returnIntent.putExtra(StaticData.EXTRA_INTENT_KEY_ACTION, StaticData.ACTION_NEW);
